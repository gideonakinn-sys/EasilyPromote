...
export function OnboardingComplete({ profile, onBrowseCampaigns }: OnboardingCompleteProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center max-w-xl text-center">
      ...
      <h2 data-reveal className="font-rethink font-medium text-[22px] tracking-tighter text-neutral-900 mb-2">
        You&apos;re all set — no campaigns yet.
      </h2>
      <p data-reveal className="font-rethink text-sm text-neutral-500 mb-8 font-medium tracking-[-0.01em]">
      ...
      <button
        ...
        className="w-full max-w-[300px] py-3 bg-[#FEB604] text-neutral-900 font-semibold text-sm rounded-full font-rethink border border-neutral-100"
      >
        Browse campaigns
      </button>
    </div>
