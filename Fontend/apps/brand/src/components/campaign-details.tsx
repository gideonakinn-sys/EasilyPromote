...
export function CampaignDetails({ campaignId, onClose, isMobile }: CampaignDetailsProps) {
  ...
  return (
    <div className={cn("h-full bg-neutral-100", isMobile ? "flex flex-col" : "flex")}>
      {/* Mobile Header */}
      {isMobile && (
        ...
        {activeTab === "Payouts" && (
          <div className={cn("space-y-10 pb-10", isMobile ? "w-full" : "w-[520px] mx-auto")}>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white border border-neutral-200 rounded-2xl p-4 space-y-2">
                <span className="text-[10px] font-medium text-neutral-500 block">Creator pool</span>
                <span className="font-rethink font-medium text-xl text-neutral-900 block">₦{creatorPool.toLocaleString()}</span>
              </div>
              <div className="bg-white border border-neutral-200 rounded-2xl p-4 space-y-2">
            ...
            <div className="space-y-0.5">
              <span className="text-[10px] font-medium text-neutral-500 block">Platform fee</span>
              <p className="text-[10px] text-neutral-400 font-rethink font-medium leading-relaxed">
