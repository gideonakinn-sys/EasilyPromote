  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl p-6 w-full max-w-xs space-y-4">
        <h3 id="confirm-delete-title" className="font-rethink font-medium text-base text-neutral-900 text-center">
          {title}
        </h3>
        <p className="font-rethink text-xs text-neutral-500 font-medium text-center">You can&apos;t undo this.</p>
