...
export function CampaignTable({ campaigns }: CampaignTableProps) {
  return (
    <div className="w-full max-w-4xl bg-white border border-neutral-200 rounded-3xl p-8 shadow-sm text-left animate-in fade-in slide-in-from-bottom-2 duration-200">
