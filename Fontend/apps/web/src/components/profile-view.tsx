...
export function ProfileView({
  ...
  const renderReconnectRow = (label: string, handle: string, onReconnect: () => void, onDisconnect: () => void) => (
    <div className="flex items-center gap-3 bg-amber-50 border border-amber-200 rounded-2xl px-4 py-3">
      ...
      <button
        onClick={onReconnect}
        className="px-4 py-2 bg-[#FEB604] text-neutral-950 rounded-full font-semibold text-xs font-rethink"
      >
        Reconnect
      </button>
      <button
    ...
    <div className="w-full max-w-lg mx-auto font-rethink">
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-4 mb-5">
            ...
            <div className="space-y-1.5">
              ...
              <button
                ...
                className="px-4 py-2 bg-white border border-neutral-200 text-neutral-900 font-semibold text-xs rounded-full font-rethink disabled:opacity-50"
              >
        ...
        <section data-reveal className="bg-white border border-red-200 rounded-3xl p-6">
          <h3 className="font-rethink font-medium text-sm text-neutral-900 mb-1">Delete account</h3>
          <p className="text-xs font-medium text-neutral-500 leading-normal mb-4">
        ...
        <div className="fixed inset-0 z-50 bg-neutral-950/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4">
            <div className="space-y-1">
              <h3 className="font-rethink font-medium text-base text-neutral-900">
                Delete your account?
              </h3>
              <p className="text-xs font-medium text-neutral-500 leading-normal">
            ...
            {deleteBlockers.length > 0 ? (
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full py-3 bg-neutral-100 text-neutral-900 rounded-full font-semibold text-xs font-rethink"
                >
                  Close
                </button>
              </div>
              ...
              <>
                ...
                <div className="space-y-1.5">
                  <label htmlFor="delete-password" className="block text-xs font-medium text-neutral-500">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white border border-neutral-200 rounded-[16px] text-sm font-medium text-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-100 focus:border-neutral-400 font-rethink"
                  />
                </div>
                <div className="flex gap-2">
                  <button
                    onClick={() => setDeleteOpen(false)}
                    disabled={deleting}
                    className="flex-1 py-3 bg-neutral-100 text-neutral-900 rounded-full font-semibold text-xs font-rethink disabled:opacity-50"
                  >
                    Cancel
                  </button>
                  <button
