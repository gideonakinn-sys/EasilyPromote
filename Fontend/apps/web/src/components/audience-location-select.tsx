...
export function AudienceLocationSelect({ id, value, onChange, placeholder = "Choose a location", exclude = [], disabled, className }: AudienceLocationSelectProps) {
  ...
  return (
    <select
      ...
      className={cn(
        "appearance-none bg-white border border-neutral-200 rounded-full px-4 py-3 text-sm font-medium font-rethink text-neutral-950 focus:outline-none focus:border-neutral-300 disabled:bg-neutral-100",
